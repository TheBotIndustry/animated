...
import 'package:animated_tesla_car/screens/components/battery_status.dart';
import 'package:animated_tesla_car/screens/components/door_lock.dart';
import 'package:animated_tesla_car/screens/components/temp_details.dart';
import 'package:animated_tesla_car/screens/components/tesla_bottom_navigationbar.dart';
import 'package:animated_tesla_car/screens/components/tyre_psi_card.dart';
import 'package:animated_tesla_car/screens/components/tyres.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  late Animation<double> _animationTempCoolGrow;
  ...
  void setupTempAnimation() {
    ...
    _animationTempCoolGrow = CurvedAnimation(
      parent: _tempAnimationController,
            ...
            bottomNavigationBar: TeslaBottomNavigationBar(
              onTap: (index) {
                ...
                if (index == 3) {
                  ...
                  _tyreAnimationController.reverse(from: 0.3);
                }
              ...
              child: LayoutBuilder(builder: (context, constrains) {
                return Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                      right: -180 * (1 - _animationTempCoolGrow.value),
